...
class Death(Scene):
    ...
    quips = ['you died. you kinda suck at this.',
            ...
            'such a luser...',
            'i have a small puppy that better a this',
            'youre worse than your dads jokes'
            ]
...
#тук пишем това защото Engine още във init иска да му се каже на коя карта ще се играе, смсл очаква scene_map
a_game = Engine(a_map)
a_game.play()